// ./components/admin/tabel/CT_Kurir.jsx
...
const CT_Kurir = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filtered = res.data.filter(user => user.role_id === 5);
        setUsers(filtered);
      } catch (err) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8">Daftar Kurir</h1>
