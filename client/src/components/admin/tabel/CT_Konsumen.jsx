// ./components/admin/tabel/CT_Konsumen.jsx
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // filter hanya konsumen (role_id = 2)
        const filtered = res.data.filter(user => user.role_id === 2);
        setUsers(filtered);
      } catch (err) {
        console.error("Gagal mengambil data konsumen:", err);
      }
    };
